...
model FlowMachine_m "Identical m_flow controlled pumps"
  extends DHC.BaseClass.PartialPumpParallel_m(
...
equation
  connect(u, product.u1) annotation (Line(points={{-120,40},{-90,40},{-90,64},{
          -32,64}},
                color={0,0,127}));
  connect(product.u2, swi.y) annotation (Line(points={{-32,52},{-32,-16},{-16,
          -16},{-16,-30},{-26,-30}},                color={0,0,127}));

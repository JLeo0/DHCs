...
model FanCoil2PipeHeating "Model of a two-pipe fan coil unit for heating,
  ...
  Modelica.Blocks.Math.Product pro_H
...
equation
  ...
  connect(TSetHea,TLoaODE.TSet)
    annotation (Line(points={{-220,200},{-120,200},{-120,48},{-12,48}},color={0,0,127}));
  ...
  connect(mulQReqHea_flow.y,gaiHeaFlo.u)
    annotation (Line(points={{-158,80},{-100,80},{-100,220},{-90,220}},  color={0,0,127}));
  connect(mulQReqHea_flow.y,TLoaODE.QReq_flow)
    annotation (Line(points={{-158,80},{-100,80},{-100,40},{-12,40}},  color={0,0,127}));
  ...
  connect(gaiMasFlo.y, pro_H.u1) annotation (Line(points={{62,220},{86,220},{86,
          106},{112,106}}, color={0,0,127}));
  connect(exp.y, pro_H.u2)
    annotation (Line(points={{101,94},{112,94}}, color={0,0,127}));
  connect(pro_H.y, mulMasFloReqHeaWat.u)
    annotation (Line(points={{135,100},{158,100}}, color={0,0,127}));
  annotation (
    Documentation(
      info="<html>
<p>
